...
export default function CardBase({
  ...
  return (
    <div className={twMerge(`relative min-h-80 w-full flex items-center bg-white shadow-sm border border-slate-200 rounded-lg p-2`, cardClass)}>
      <div className="p-3">
 ...
 <Image
        ...
        {description && <p className="text-slate-600 leading-normal font-light mb-4 max-w-lg">{description}</p>}
        {buttonText && linkHref && (
