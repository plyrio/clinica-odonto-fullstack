...
export default function TitlesSection({ title, subtitle, subtitleClassName, titleClassName, baseClassName }: TitlesSectionProps) {
  return (
    <div className="mb-9 text-center leading-6">
      <h6 className={twMerge(`text-base text-blue-600 mb-4 font-semibold`, subtitleClassName)}>{subtitle}</h6>
      <h2 className={twMerge(`text-3xl md:text-4xl font-bold text-zinc-600 m-0 leading-5`, titleClassName)}>{title}</h2>
