...
export default function UserMenu({ user }: Props) {
  const { menuOpen, menuRef, toggleMenu } = useDropdown("userMenu");
    ...
    <div className="flex justify-center items-center gap-4">
      ...
      <div ref={menuRef} className="relative md:flex">
        ...
        <div
          className={`${
            menuOpen
              ? "absolute top-12 end-0 z-10 mt-0.5 w-56 divide-y divide-gray-100 rounded-md border border-gray-100 bg-white shadow-lg list-none"
              : "hidden"
          } `}
          role="menu"
        >
