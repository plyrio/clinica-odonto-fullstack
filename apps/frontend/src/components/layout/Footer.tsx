        ...
        <div className='flex flex-wrap'>
          <div className='flex w-full lg:w-1/4 lg:max-w-[25%] md:w-1/2 md:max-w-[50%] px-3 mb-9 relative'>
            <div className='pr-0'>
              <Link
                href='/'
                className='mb-5 inline-block transition duration-400 ease-in-out outline-none text-zinc-600 bg-transparent'>
                <Image
                  src={LOGO}
                  alt='Logo'
                  width={50}
                  height={50}
                  className='h-auto rounded flex items-center w-8'
                />
              </Link>
