...
export function Footer() {
    ...
    <div className="xl:container p-4 mx-auto">
        <div className="lg:flex">
          ...
          <Image src={LOGO} height={32} width={32} alt="Flowbite Logo" />
          <span className="self-center text-2xl font-semibold whitespace-nowrap">{CLINIC_INFO.name}</span>
        </Link>

                    <p className=" mt-2 text-gray-500">{CLINIC_INFO.description}</p>
        ...
        <div className="h-px my-6 bg-gray-200 border-none"></div>
