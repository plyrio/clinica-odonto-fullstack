        ...
        <div className="flex flex-col w-full lg:w-1/2">
          <TitlesSection
            title={
              <>
                Por que escolher a{" "}
                <span className="text-blue-600">Clinica Odonto</span> para
                extração dentária?
              </>
            }
          ...
          <div className="">
            <p>
              Na Clinica Odonto, entendemos que a extração dentária pode ser uma
              experiência preocupante. Por isso, oferecemos um atendimento
              humanizado, com profissionais altamente qualificados e tecnologia
              de ponta para garantir um procedimento seguro, eficiente e o mais
              confortável possível.
            </p>
          </div>
          <ul className="flex flex-wrap p-0 list-none mb-0 mt-2.5 mx-[-10px]">
            {list.map((item, i) => (
              <li key={i} className="flex w-full md:w-1/2 mt-5 px-2.5">
