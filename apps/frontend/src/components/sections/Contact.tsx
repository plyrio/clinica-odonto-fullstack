...
export default function Contact() {
  return (
      <section className="max-h-max bg-white dark:bg-gray-900 lg:flex">
      <div className="flex-col justify-center w-full p-8 bg-contact-form bg-cover bg-center  lg:px-12 xl:px-32 lg:w-1/2 hidden lg:flex">
