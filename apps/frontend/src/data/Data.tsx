...
export const CLAREAMENTO =
 '/src/assets/images/services/clean-tooth (1).png';
export const IMPLANTE =
 '/src/assets/images/services/dental-implant.png';
export const PROTESE =
 '/src/assets/images/services/prothesis.png';
export const ORTODONTIA =
 '/src/assets/images/services/braces.png';
export const LIMPEZA =
 '/src/assets/images/services/clean-tooth.png';
...
export const CLINIC_INFO: ClinicInfo =
 {
  name: 'Odonto+',
  description:
   'Acreditamos que um sorriso saudável é a chave para uma vida mais feliz e confiante Nossa missão é transformar vidas através de cuidados odontológicos personalizados, sempre priorizando o bem-estar e a satisfação de nossos pacientes.',
  address:
   'Rua dos Sorrisos, 123, Centro, São Paulo, SP',
  phone:
   '(11) 98765-4321',
  email:
   'contato@odontoplus.com.br',
  socialMedia: [
   {
    id: 1,
    name:
   ...
   },
   {
    ...
    name:
     'Instagram',
    url: 'https://www.instagram.com/odontoplus',
    icon:
     IconBrandInstagramFilled,
   },
   {
    ...
    name:
     'LinkedIn',
    url: 'https://www.linkedin.com/company/odontoplus',
    icon:
     IconBrandLinkedinFilled,
   },
   {
    id: 4,
    name: 'YouTube',
    url: 'https://www.youtube.com/channel/odontoplus',
    icon:
     IconBrandYoutubeFilled,
   },
  ],
...
export const PARTNERS: Partner[] =
 [
  ...
  },
  {
   ...
   logo:
    '/images/partners/straumann.png',
  },
  {
   id: 4,
   name: 'Neodent',
   website:
    'https://www.neodent.com.br',
   logo:
    '/images/partners/neodent.png',
  },
 ];
  ...
  contactInfo: [
   {
    icon:
     IconHomeFilled,
    text:
     'Rua dos Sorrisos, 310, Vila Vleha - ES',
   },
   {
    icon:
     IconPhoneFilled,
  ...
  socialMedia: [
   {
    ...
    name:
     'Facebook',
    url: 'https://www.facebook.com/odontoplus',
    icon:
     IconBrandFacebookFilled,
   },
   {
