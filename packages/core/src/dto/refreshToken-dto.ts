...
export class RefreshTokenResponseFullZodDto extends createZodDto(refreshTokenResponseFullSchema) { }
...
export type RefreshTokenResponseFullDto = z.infer<typeof refreshTokenResponseFullSchema>;
